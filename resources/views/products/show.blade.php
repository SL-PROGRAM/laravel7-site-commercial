        ...
        @if(session()->has('cart'))
            <div class="modal">
                <div class="modal-content center-align">
                    <h5>Product ajouté au panier avec succès</h5>
                    <hr>
                    ...
                    <p><em>Vous avez la possibilité de venir chercher vos products sur place, dans ce cas vous cocherez la case correspondante lors de la confirmation de votre commande et aucun frais de port ne vous sera facturé.</em></p>
